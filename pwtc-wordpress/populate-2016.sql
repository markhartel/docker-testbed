...
LOAD DATA INFILE '/var/lib/mysql-files/2016-Rides.csv' INTO TABLE wp_pwtc_club_rides FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\r\n' (post_id, title, @datetime, @dummy, @dummy, @dummy, @dummy, @dummy, @dummy) SET date = CAST(@datetime AS DATE);
...
LOAD DATA INFILE '/var/lib/mysql-files/2016-RideSheets.csv' INTO TABLE temp_ride_mileage FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\r\n' (ride_id, member_id, mileage);
...
LOAD DATA INFILE '/var/lib/mysql-files/2016-Rides.csv' INTO TABLE temp_club_rides FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\r\n' (ride_id, @dummy, @dummy, leader1, leader2, leader3, leader4, @dummy, @dummy);
